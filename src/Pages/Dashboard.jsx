 ...
 */}
      ...
      >
        ...
        <div className="flex space-x-1 border-b bg-gray-100 rounded-t-lg shadow-md px-1">
          <button
            className={`px-4 py-2 text-sm rounded-t-md transition-all duration-200 ${activeTab === "QA"
          ...
          <button
            className={`px-4 py-2 text-sm rounded-t-md transition-all duration-200 ${activeTab === "Matching Details"
                ? "bg-white font-bold border-t-2 border-x-2 border-blue-500 shadow-sm"
                : "text-gray-600 bg-gray-200 hover:bg-gray-300"
              }`}
