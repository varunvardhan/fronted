...
const QuestionComponent = ({ submissionId, candidateName, onAddQuestion }) => {
  ...
  const handleLevelClick = async (level) => {
    ...
    try {
      ...
      // Add the prompt question to the list
  ...
  return (
    <div className="p-3 bg-white rounded-b-xl flex items-center border-t">
      ...
      <input
        ...
        placeholder="Type your question here and click difficulty level buttons..."
        value={question}
